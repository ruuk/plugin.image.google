...
class ThreadPool:
    ...
    def dismissWorkers(self, num_workers=0, do_join=False):
        ...
        dismiss_list = []
        if not num_workers: num_workers = len(self.workers)
    ...
    def poll(self, block=False,return_results=False,progress=None):
    ...
    def wait(self,return_results=False,progress=None):
        """Wait for results, blocking until all have arrived."""
        while 1:
            try:
                self.poll(True,return_results,progress)
